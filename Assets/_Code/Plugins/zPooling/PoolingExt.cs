...
namespace Pooling {
   ...
   public static class PoolingExt {
      ...
      /// <returns>Instantiated object</returns>
      public static T Pool<T>(this GameObject prefab, Vector3 position) where T : MonoBehaviour, IGenericPoolElement {
         return GenericPooler.InstantiateFromPool<T>(prefab, position);
      }
      ...
      /// <returns>Instantiated object</returns>
      public static T Pool<T>(this GameObject prefab, Quaternion rotation)
         where T : MonoBehaviour, IGenericPoolElement {
         return GenericPooler.InstantiateFromPool<T>(prefab, rotation);
      }
      ...
      /// <param name="rotation">Rotation of instantiated transform</param>
      /// <returns>Instantiated object</returns>
      public static T Pool<T>(this GameObject prefab, Vector3 position, Quaternion rotation)
         where T : MonoBehaviour, IGenericPoolElement {
         return GenericPooler.InstantiateFromPool<T>(prefab, position, rotation);
      }
      ...
      /// <param name="worldPosStays">Optional worldPositionStays for internal SetParent call</param>
      /// <returns>Instantiated object</returns>
      public static T Pool<T>(this GameObject prefab,
                              Transform parent,
                              bool worldPosStays = true) where T : MonoBehaviour, IGenericPoolElement {
         return GenericPooler.InstantiateFromPool<T>(prefab, parent, worldPosStays);
      }
      ...
      public static T Pool<T>(this GameObject prefab,
                              ...
                              Transform parent,
                              bool worldPosStays = true) where T : MonoBehaviour, IGenericPoolElement {
         return GenericPooler.InstantiateFromPool<T>(prefab, position, rotation, parent, worldPosStays);
      }
      ...
      /// <param name="position">Position where it should be instantiated</param>
      /// <returns>Instantiated object</returns>
      public static T AutoPool<T>(this GameObject prefab, Vector3 position)
         where T : MonoBehaviour, IGenericPoolElement {
         return AutoPooler.InstantiateFromPool<T>(prefab, position);
      }
      ...
      /// <param name="rotation">Rotation of instantiated transform</param>
      /// <returns>Instantiated object</returns>
      public static T AutoPool<T>(this GameObject prefab, Quaternion rotation)
         where T : MonoBehaviour, IGenericPoolElement {
         return AutoPooler.InstantiateFromPool<T>(prefab, rotation);
      }
      ...
      /// <param name="rotation">Rotation of instantiated transform</param>
      /// <returns>Instantiated object</returns>
      public static T AutoPool<T>(this GameObject prefab, Vector3 position, Quaternion rotation)
         where T : MonoBehaviour, IGenericPoolElement {
         return AutoPooler.InstantiateFromPool<T>(prefab, position, rotation);
      }
      ...
      /// <param name="worldPosStays">Optional worldPositionStays for internal SetParent call</param>
      /// <returns>Instantiated object</returns>
      public static T AutoPool<T>(this GameObject prefab,
                                  Vector3 position,
                                  Quaternion rotation,
                                  Transform parent,
                                  bool worldPosStays = true) where T : MonoBehaviour, IGenericPoolElement {
         return AutoPooler.InstantiateFromPool<T>(prefab, position, rotation, parent, worldPosStays);
      }
      ...
      public static T AutoPool<T>(this GameObject prefab,
                                  Transform parent,
                                  bool worldPosStays = true) where T : MonoBehaviour, IGenericPoolElement {
         return AutoPooler.InstantiateFromPool<T>(prefab, parent, worldPosStays);
      }
